...
module e203_subsys_main(
  ...
  output [31:0] inspect_pc_pass
  );

 wire [31:0] inspect_pc;
// wire [31 : 0] inspect_pc_pass;
 assign inspect_pc_pass = inspect_pc;
...
`endif//}
  ...
  reg [7:0] debug_sample_cnt;
  always @(posedge hfclk or negedge core_rst_n) begin
    if (!core_rst_n)
      debug_sample_cnt <= 8'b0;
    else
      debug_sample_cnt <= debug_sample_cnt + 1'b1;
  end

  // Temporary trap-store ILA. Trigger on probe0 == 0x9000_01f0.
  // probe0[31:0] = mem_icb_cmd_addr
  // probe1[31:0] = mem_icb_cmd_wdata
  ila_0 u_ila_sys_boot (
    .clk    (hfclk),
