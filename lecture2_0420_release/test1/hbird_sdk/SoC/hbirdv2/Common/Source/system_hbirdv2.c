...
volatile unsigned long g_trap_debug_magic;
volatile unsigned long g_trap_debug_mcause;
volatile unsigned long g_trap_debug_mepc;
volatile unsigned long g_trap_debug_mtval;
volatile unsigned long g_trap_debug_sp;
...
{
    g_trap_debug_magic = 0x54524150UL;
    g_trap_debug_mcause = mcause;
    g_trap_debug_mepc = __RV_CSR_READ(CSR_MEPC);
    g_trap_debug_mtval = __RV_CSR_READ(CSR_MBADADDR);
    g_trap_debug_sp = sp;
    while (1) {
    }
