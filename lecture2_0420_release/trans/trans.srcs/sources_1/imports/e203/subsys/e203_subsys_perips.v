...
w4a8_linear_engine u_w4a8_engine (
    ...
    .icb_cmd_ready (expl_axi_icb_cmd_ready),
    .icb_cmd_addr  (expl_axi_icb_cmd_addr ),
    .icb_cmd_read  (expl_axi_icb_cmd_read ),
    .icb_cmd_wdata (expl_axi_icb_cmd_wdata),
    .icb_cmd_wmask (expl_axi_icb_cmd_wmask),
    .icb_rsp_valid (expl_axi_icb_rsp_valid),
    .icb_rsp_ready (expl_axi_icb_rsp_ready),
    .icb_rsp_rdata (expl_axi_icb_rsp_rdata),
    .icb_rsp_err   (expl_axi_icb_rsp_err  )
  );
